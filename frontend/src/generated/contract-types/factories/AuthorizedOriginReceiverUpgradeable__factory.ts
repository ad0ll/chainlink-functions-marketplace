...
} from "../AuthorizedOriginReceiverUpgradeable";
...
export class AuthorizedOriginReceiverUpgradeable__factory {
  ...
  static createInterface(): AuthorizedOriginReceiverUpgradeableInterface {
    return new Interface(_abi) as AuthorizedOriginReceiverUpgradeableInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as AuthorizedOriginReceiverUpgradeable;
  }
}
