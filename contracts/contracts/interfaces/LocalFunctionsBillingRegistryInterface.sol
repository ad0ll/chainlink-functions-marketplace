...
/**
 * !!NOTE!!: This is entirely copied from the hardhat starter repo
 * We have it here because we need getSubscription(), createSubscription(), and
 * addConsumer() and the native interface doesn't expose those functions
 */
 ...
 */
interface LocalFunctionsBillingRegistryInterface {
     ...
     */
    function getRequiredFee(bytes calldata data, LocalFunctionsBillingRegistryInterface.RequestBilling memory billing)
        external
        view
        returns (uint96);
    ...
    /**
     * !!!NOTE!!!: These are the functions we needed
     */
