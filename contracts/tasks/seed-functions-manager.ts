...
const imageUrls = {
    ...
    cryptoCompare:
        "https://www.cryptocompare.com/media/20562/favicon.png?v=10",
    coinPaprika: "https://coinpaprika.com/assets/img/cp-logo-small.svg",
    weather: "https://upload.wikimedia.org/wikipedia/commons/8/80/GNOME_Weather_icon_2018.svg",
    httpLink: "https://upload.wikimedia.org/wikipedia/commons/e/e9/OOjs_UI_icon_link-ltr-invert.svg",
    coinMarketCap: "https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Fmiro.medium.com%2Fmax%2F2400%2F1*KLgE-Hc-dNuqgLYWMujhAQ%402x.png&f=1&nofb=1&ipt=9769eedc2bf4aad1e0f738f3ec8bcb6e44fffaf88998dbea155a989f2976542a&ipo=images",
};
        ...
        const demos: DemoConfig[] = [
            ...
            },
            {
                ...
                register: {
                    ...
                    imageUrl: imageUrls.cryptoCompare,
            ...
            },
            {
                ...
                register: {
                    ...
                    imageUrl: imageUrls.coinPaprika,
                    expectedArgs: ["Base", "Quote"],
                    codeLocation: 0,
                    secretsLocation: 0,
                    language: 0,
            ...
            },
            {
                ...
                register: {
                    ...
                    imageUrl: imageUrls.coinMarketCap,
                    expectedArgs: ["Base", "Quote"],
                    codeLocation: 0,
                    secretsLocation: 1,
                    language: 0,
